...
class TestCases(unittest.TestCase):
    ...
    def test_access_unauthenticated(self):
        ...
        result, code = app.tests.utils.HTTP_GET(variables.DEFAULT_API_URL + '/distributionowners', {}, {}, {})
        self.assertEqual(code, 401)
        
        # tries to get one distribution owner, must work
        result, code = app.tests.utils.HTTP_GET(variables.DEFAULT_API_URL + '/distributionowners/' + distributionOwnerId, {}, {}, {})
        self.assertEqual(code, 200)
        
        # tries to POST a distribution owner, must fail
        result, code  = app.tests.utils.HTTP_POST(variables.DEFAULT_API_URL + '/distributionowners', 
                {}, 
                {}, 
                ujson.dumps({"name":"name"}))
        self.assertEqual(code, 401)
        # tries to PUT a distribution owner, must fail
        result, code  = app.tests.utils.HTTP_PUT(variables.DEFAULT_API_URL + '/distributionowners/' + distributionOwnerId, 
        {}, 
        {}, 
    ...
    def test_access_authenticated(self):    
        ...
        result, code =  app.tests.utils.HTTP_PUT(variables.DEFAULT_API_URL + '/distributionowners/' +newDO , 
                    {'cookie':session_cookie}, 
                    {}, 
