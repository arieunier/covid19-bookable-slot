...
class TestCases(unittest.TestCase):
    ...
    def test_access_unauthenticated(self):
        ...
        result, code = app.tests.utils.HTTP_GET(variables.DEFAULT_API_URL + '/recurringslotstemplates', {}, {}, {})
        self.assertEqual(code, 401)
        # gets A recurringslottemplate
        result, code = app.tests.utils.HTTP_GET(variables.DEFAULT_API_URL + '/recurringslotstemplates/' + recSlotId, {}, {}, {})
        self.assertEqual(code, 401)
        # tries to update the correct recurring slot template
        result, code = app.tests.utils.HTTP_PUT(variables.DEFAULT_API_URL + '/recurringslotstemplates/' + recSlotId, {}, {}, {'name':'unknown'})
        self.assertEqual(code, 401)

        #adds an openinghourstemplate but fails because can't access it unauthenticated state
        result, code  = app.tests.utils.HTTP_POST(variables.DEFAULT_API_URL + '/recurringslotstemplates', 
                {}, 
                {}, 
        ...
        # access unknown data
        result, code = app.tests.utils.HTTP_GET(variables.DEFAULT_API_URL + '/recurringslotstemplates/unknown', 
        {}, {}, {})
        self.assertEqual(code, 401)
    ...
    def test_access_authenticated(self):    
        ...
        #gets it    
        result, code = app.tests.utils.HTTP_GET(variables.DEFAULT_API_URL + '/recurringslotstemplates/'+uid, 
        {'cookie':session_cookie}, {}, {})
        self.assertEqual(code, 200)
        ...
        #update it
        result, code  = app.tests.utils.HTTP_PUT(variables.DEFAULT_API_URL + '/recurringslotstemplates/'+uid, 
                {'cookie':session_cookie}, 
                {}, 
