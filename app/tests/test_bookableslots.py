...
class TestCases(unittest.TestCase):
    ...
    def test_access_unauthenticated(self):
        ...
        result, code = app.tests.utils.HTTP_GET(variables.DEFAULT_API_URL + '/bookableslots', {}, {}, {})
        self.assertEqual(code, 404)
    
        # access bookable slots with an incorrect dp, must fail
        result, code = app.tests.utils.HTTP_GET(variables.DEFAULT_API_URL + '/bookableslots/unknown', {}, {}, {})
        ...
        result, code = app.tests.utils.HTTP_GET(variables.DEFAULT_API_URL + '/bookableslots/' + distributionPointId, {}, {'dateStart':tomorrow}, {})
        self.assertEqual(code, 200)
    ...
    def test_access_authenticated(self):    
        ...
        result, code = app.tests.utils.HTTP_DEL(variables.DEFAULT_API_URL + '/bookableslots/' + firstBookableSlotId, {}, {},{})
        self.assertEqual(code, 500)
        #deletes the second properly
        result, code = app.tests.utils.HTTP_DEL(variables.DEFAULT_API_URL + '/bookableslots/' + secondBookableSlotId, {}, {},{})
        self.assertEqual(code, 200)
