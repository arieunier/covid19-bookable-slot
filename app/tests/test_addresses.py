...
class TestCases(unittest.TestCase):
    ...
    def test_access_unauthenticated(self):
        ...
        # gets all addresses
        result, code = app.tests.utils.HTTP_GET(variables.DEFAULT_API_URL + '/addresses', {}, {}, {})
        self.assertEqual(code, 401)
        
        #adds an adress but fails because can't access it unauthenticated state
        result, code  = app.tests.utils.HTTP_POST(variables.DEFAULT_API_URL + '/addresses', 
                {}, 
                {}, 
        ...
        # access unknown data
        result, code = app.tests.utils.HTTP_GET(variables.DEFAULT_API_URL + '/addresses/unknown', 
        {}, {}, {})
        self.assertEqual(code, 401)
    ...
    def test_access_authenticated(self):    
        ...
        # gets all addresses
        result, code = app.tests.utils.HTTP_GET(variables.DEFAULT_API_URL + '/addresses', {'cookie':session_cookie}, {}, {})
        self.assertEqual(code, 200)
        ...
        #gets it    
        result, code = app.tests.utils.HTTP_GET(variables.DEFAULT_API_URL + '/addresses/'+address_id, 
        {'cookie':session_cookie}, {}, {})
        self.assertEqual(code, 200)
        currentNbOfAddresses = len(result.json)
        ...
        #update it
        result, code  = app.tests.utils.HTTP_PUT(variables.DEFAULT_API_URL + '/addresses/'+address_id, 
                {'cookie':session_cookie}, 
                {}, 
