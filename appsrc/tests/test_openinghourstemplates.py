...
class TestCases(unittest.TestCase):
    ...
    def test_access_unauthenticated(self):
        ...
        # gets all addresses
        result, code = appsrc.tests.utils.HTTP_GET('/api/covid19/openinghourstemplates', {}, {}, {})
        self.assertEqual(code, 401)
        
        #adds an openinghourstemplate but fails because can't access it unauthenticated state
        result, code  = appsrc.tests.utils.HTTP_POST('/api/covid19/openinghourstemplates', 
                {}, 
                {}, 
        ...
        # access unknown data
        result, code = appsrc.tests.utils.HTTP_GET('/api/covid19/openinghourstemplates/unknown', 
        {}, {}, {})
        self.assertEqual(code, 401)
    ...
    def test_access_authenticated(self):    
        ...
        result, code = appsrc.tests.utils.HTTP_GET('/api/covid19/openinghourstemplates', {'cookie':session_cookie}, {}, {})
        self.assertEqual(code, 200)
        ...
        #gets it    
        result, code = appsrc.tests.utils.HTTP_GET('/api/covid19/openinghourstemplates/'+uid, 
        {'cookie':session_cookie}, {}, {})
        self.assertEqual(code, 200)
        currentNbOfAddresses = len(result.json)
        ...
        #update it
        result, code  = appsrc.tests.utils.HTTP_PUT('/api/covid19/openinghourstemplates/'+uid, 
                {'cookie':session_cookie}, 
                {}, 
